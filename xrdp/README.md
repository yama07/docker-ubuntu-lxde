...
- ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/yama07/docker-ubuntu-lxde/20.04_ja?style=flat-square)
...
- ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/yama07/docker-ubuntu-lxde/20.04-pulseaudio_ja?style=flat-square)
...
- ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/yama07/docker-ubuntu-lxde/20.04-core_ja?style=flat-square)
  `20.04-core_ja`, `focal-core_ja`: 最小限コンポーネントの Ubuntu20.04 ベース [(xrdp/Dockerfile.ubuntu20.04_core)](https://github.com/yama07/docker-ubuntu-lxde/blob/master/xrdp/Dockerfile.ubuntu20.04_core)
- ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/yama07/docker-ubuntu-lxde/22.04_ja?style=flat-square)
...
- ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/yama07/docker-ubuntu-lxde/22.04-pulseaudio_ja?style=flat-square)
...
- ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/yama07/docker-ubuntu-lxde/22.04-core_ja?style=flat-square)
